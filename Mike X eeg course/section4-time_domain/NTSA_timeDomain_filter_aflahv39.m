...
%% done.
%ERP itself will actually cutoff higher frequency
%there is no or little difference when comparing 3 types, this is because
%they are linear operation where order doesnt matter(you can do erp at
%first or after filtering. however, order matter when we are doing
